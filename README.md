...
This project aims to analyze betting data using AI-driven microservices, providing insights that enhance decision-making and improve betting strategies. The flow diagram above shows how data moves between these services, including the API, OCR, LLM, and Storage services. In its current state this application is mainly a data extraction engine.
